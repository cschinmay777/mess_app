...
class OnTapMess extends StatefulWidget {
  const OnTapMess({Key? key}) : super(key: key);

  @override
  State<OnTapMess> createState() => _OnTapMessState();
}

class _OnTapMessState extends State<OnTapMess> {
  //data recieved from previous screen
  MessModel messdata = Get.arguments;
